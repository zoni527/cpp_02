...
/*   Updated: 2025/06/06 18:37:16 by jvarila          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * in base 10. UPDATE: in C++ 20 sign is guaranteed to be maintained in shifts.
 *
 * -> 1234 * 100
 *  = 1234 * 10 * 10
 *  = 12340 * 10
...
Fixed Fixed:: operator * ( Fixed const &fixed ) {
	Fixed product;
	product.setRawBits( (_value * fixed._value) >> _fractional_bits );
	return product;
}
